...
* **The unemployment rate was `r percent(d,accuracy = 0.01)`, which is `r percent(abs(d-e),accuracy = 0.01,suffix = 'pp.')` `r de` than one year before.** The participation rate was `r percent(f,accuracy = 0.01)`, which is `r percent(abs(f-g),accuracy = 0.01,suffix = 'pp.')` `r de` than same trimester last year.
